...
# do conversion
speed_base = 100 * 0.28 # Daija's note: 100 km/hr = 27.78 m/s
...
nsample = 200
mean_speed = log(100*0.277) # Daija's note: 100 km/hr = 27.78 m/s
...
```{r Daija's notes}
# pmap is an internal R function that does the looping for you
...
# the list is going row by row by row
# first give it the variables you want to step through
# next give it the function
# pmap and mapply run faster than for loops
