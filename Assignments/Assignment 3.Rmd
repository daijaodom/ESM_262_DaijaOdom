...
# quick visualization
method1_plot = ggplot(powerall_r1, aes(car,power, fill=car))+geom_boxplot()+ggtitle("For Loop")
...
method2_plot = ggplot(powerall_r2, aes(car,power, fill=car))+geom_boxplot()+ggtitle("pmap")
method2_plot
